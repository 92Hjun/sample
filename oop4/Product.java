public class Product {
	...
	public Product(int no, String name, String maker, int price) {
		this(no, name, maker, "새제품", price);
		System.out.println("(int, String, String, String, 새제품 ,int) is running");
	}

	// this(int, String, String, String, int)와 같은 형식으로 클래스 내부에서 사용할 수 있다.
	public Product(int no, String name, String maker, String category, int price) {
		...
		System.out.println("(int, String, String, String, String, int) is running");
	} 

	// this(int, String, String, String, String, int, double, boolean)와 같은 형식으로 클래스 내부에서 사용할 수 있다.
	public Product(int no, String name, String maker, String category,
		...
		this.isFree = isFree;
		System.out.println("(int, String, String, String, String, int, double, boolean) is running");
	}
